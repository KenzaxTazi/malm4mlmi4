...
class Classifier(MetaModule):
    ...
    def __init__(self, conv, K, N):
        ...
        if self.conv == True:
            self.conv1 = MetaConv2d(1, 64, 3, stride=2) #3x3 convolutions 64 filters
            self.conv2 = MetaConv2d(64, 64, 3, stride=2)
            self.conv3 = MetaConv2d(64, 64, 3, stride=2)
            self.conv4 = MetaConv2d(64, 64, 3, stride=2)

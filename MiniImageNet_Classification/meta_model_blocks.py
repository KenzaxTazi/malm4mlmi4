'''
Meta Conv module defined by: https://github.com/tristandeleu/pytorch-maml/blob/master/maml/model.py

The difference between Meta modules and regular torch.nn modules is
the updated format of the forward method: it accepts parameters to
replace the torch.nn parameters in the constructor; this allows the
computation graph to be preserved through passed parameters.
'''
